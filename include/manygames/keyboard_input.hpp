...
{ 
  ...
  protected:
    ...
    std::map<key_and_mod, std::string> keyname_overrides_with_modifier;
    std::map<unsigned, std::string> keyname_overrides;
    std::map<unsigned, std::string> modifier_name_overrides;
  ...
  public:
    ...
    // represents.  For longer keys, it would be the  
    ...
    virtual void override_modifier(unsigned modifier, const std::string& new_name);
